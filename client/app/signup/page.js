            ...
            <h1 className='text-xl font-bold text-gray-800 text-center'>  Register </h1>
                <form className='mt-5'>
                    ...
                    <div className="btn mt-5">
                        <Link type='submit' href={'/'} className='rounded-md block text-center  mt-2 bg-[#de4c2b] py-2 px-10 text-white cursor-pointer '>Register</Link>
                    </div>
                </form>

                   <p className='mt-5 text-gray-600 text-sm'>Already have a account? <Link className='underline' href={"/login"}> Login </Link></p>
